    ...
    <>
      <div className="min-h-full">
            ...
            <div className="fixed inset-0 z-40 flex">
              ...
              >
                <Dialog.Panel className="relative flex w-full max-w-xs flex-1 flex-col bg-red-700 pt-5 pb-4">
                  ...
                  <nav
                    className="mt-5 flex flex-1 flex-col divide-y divide-red-600 overflow-y-auto"
                    aria-label="Sidebar"
                  >
                    {/* orders links mobile */}
        ...
        <div className="hidden lg:fixed lg:inset-y-0 lg:flex lg:w-64 lg:flex-col">
          ...
          <div className="flex flex-grow flex-col overflow-y-auto bg-red-800 pt-32 pb-4">
            <nav
