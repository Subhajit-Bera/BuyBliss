...
const RegisterForm = () => {
  ...
  //Destructuring register form data
              ...
              <div className="py-20 text-center">
                ...
                <form onSubmit={onSubmitHandler}>
                  ...
                  {loading ? (
                    ...
                    <button className="mt-12 md:mt-16 bg-red-500 hover:bg-red-600 text-white font-bold font-heading py-5 px-8 rounded-md uppercase">
                      Register
                    </button>
                  )}
                </form>
