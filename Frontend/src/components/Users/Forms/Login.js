...
const Login = () => {
  ...
  const onSubmitHandler = (e) => {
    e.preventDefault(); // e.preventDefault() -> we can over what happens when an event occurs,and implement custom behavior for the event, as needed.
                ...
                <form className="flex flex-wrap -mx-4"onSubmit={onSubmitHandler}>
                  ...
                  <div className="w-full px-4">
                    {loading ? (
                      ...
                      <button className="bg-red-500 hover:bg-red-600 text-white font-bold font-heading py-5 px-8 rounded-md uppercase">
                        Login
                      </button>
                    )}
                  </div>
