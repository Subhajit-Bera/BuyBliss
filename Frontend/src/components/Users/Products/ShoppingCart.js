            ...
            <dl className="mt-6 space-y-4">
              ...
              <form onSubmit={applyCouponSubmit}>
                ...
                {loading ? (
                  ...
                  <button className="inline-flex  text-center mt-4 items-center rounded border border-transparent bg-red-500 px-2.5 py-1.5 text-xs font-medium text-white shadow-sm hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2">
                    Apply coupon
                  </button>
                )}
              </form>
