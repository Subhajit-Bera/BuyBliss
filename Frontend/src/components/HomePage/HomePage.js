...
const offers = [
  {
    ...
    description: "Get an exclusive ₹50 off code",
    href: "#",
  },
  {
        ...
        <div className="relative overflow-hidden">
          ...
          >
            <div className="mx-auto max-w-2xl lg:max-w-none">
              ...
              <a
                href="#"
                className="mt-6 inline-block w-full rounded-md border border-transparent bg-red-600 py-3 px-8 font-medium text-white hover:bg-red-800 sm:w-auto"
              >
